...
export default function CatalogsList() {
  ...
  if (error) {
    return (
      <div className="page-container">
        <div className="card" style={{ background: 'rgba(239, 68, 68, 0.1)', borderColor: 'rgba(239, 68, 68, 0.3)', display: 'flex', alignItems: 'center', gap: '12px' }}>
    ...
    <div className="page-container">
      ...
      <div className="card">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
          <h3 style={{ fontSize: "20px", fontWeight: "600", display: 'flex', alignItems: 'center', gap: '12px', margin: 0 }}>
                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <div className="action-buttons" style={{ justifyContent: "center" }}>
                      <button className="btn btn-sm btn-secondary" onClick={() => handleEdit(item)} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <Icons.Edit />
                        Editar
                      </button>
                      <button className="btn btn-sm btn-danger" onClick={() => handleDelete(item.id)} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <Icons.Trash />
                        Eliminar
                      </button>
                    </div>
